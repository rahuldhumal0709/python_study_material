...
# 1)19/11/2022-Saturday
# 	*1)Read and study carefully the Edyoda replica project
# 	*2)Understood the json concept carefully
# 	*3)Expect min 5 hour quality study
    ...
    while True:
        ...
        if choice == 2:
            ...
            if login_choice == 2:
                email_id = input("Enter your email ID : ")
                password = input("Enter your password : ")
                flag = login("student.json",email_id,password)
                if flag:
                    print("Login Successful")
                    student_choice = int(input("Enter \n1.Show Module \n2.Instructor \n3.Submissions \n4.Certification \n5.Performance \n5.Batchmates \n6.Placements \n"))
                    ...
                    #Instructor
                    if student_choice == 2:
                        flag=instructor("manager.json",name,mobile,email)
                        file=open("manager.json")
                        data= json.load(file)
                        for i in range(len(data)):
                            print("Event Name: " +str(data[i]['Full Name']))
                            print("Start Date: " +str(data[i]['Mobile Number']))
                            print("Start Time: " +str(data[i]['Email']))
