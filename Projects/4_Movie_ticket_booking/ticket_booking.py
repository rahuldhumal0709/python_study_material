class Movie_ticket:
    ...
    def buy_ticket(self):
        ...
        option = int(input(f"Your opt rows is {row1} and column is {column1},so the price for your seat is {ticket_price} RS.If you still wish to book the ticket please enter \n1.Yes \n2.No \n"))
        if option == 1:
